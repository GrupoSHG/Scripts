SELECT
    ...
    -- Agregamos el precio unitario (asumiendo que viene de DOCDE_DB)
    DD.PRECUNIT                                                         AS [precio_unitario],
    
    -- Multiplicamos cantidad por precio unitario para el total
...
ORDER BY NV.NUMNOTA, D.NUMFACT, DD.ITEMSELECT
